...
export const formText = {
  ...
  collab: {
    title: "Join The Team",
    desc: "Developers, designers, product managers, – if you're passionate about shaping the future of the job search process, let's team up and build something incredible together.",
    btn: "Submit",
    link: " Get Notified",
  },
};
